...
function FooterComponent() {
  return (
    <div className="bg-gray-800 text-white px-5 mt-72 md:mt-0 md:pb-0 pb-4 lg:h-52 flex items-center">
      <div className="container mx-auto mt-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold">PT. PRIMA DATA UTAMA SENTOSA</h2>
            <p className="text-gray-400">
              Green Ayana No.2, Jl.Raya Inpres, Kel.Gaga, Kec. Larangan,
              Ciledug, Tangerang 15154
            </p>
            <p className="text-gray-400">Phone: +6221 2227 2148</p>
          ...
          <div className="flex flex-col items-center gap-6 text-center justify-center">
            <div className="flex gap-14 md:gap-8 text-center justify-center">
              <a
                href="#home"
